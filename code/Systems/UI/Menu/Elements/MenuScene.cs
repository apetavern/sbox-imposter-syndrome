...
namespace ImposterSyndrome.Systems.UI
{
	public class MenuScene : Panel
	{
		...
		private void AddSceneAnimChildren( SceneWorld world )
		{
			Player = new SceneAnimChild( world, "models/playermodel/terrysus.vmdl",
			...
			new SceneAnimChild( world, "models/playermodel/terrysus.vmdl",
		...
		public void Build()
		{
			...
			new SceneModel( world, "models/menus/menuscene/menuscene.vmdl", Transform.Zero.WithScale( 1 ) );

			AddSceneAnimChildren( world );

			new SceneLight( world, Vector3.Up * 150.0f, 300.0f, Color.White * 5.0f );
			new SceneLight( world, Vector3.Up * 75.0f + Vector3.Forward * 100.0f, 200, Color.White * 15.0f );
			new SceneLight( world, Vector3.Up * 75.0f + Vector3.Left * 100.0f, 200, GetSkyColor() * 20.0f );
			new SceneLight( world, Vector3.Up * 75.0f + Vector3.Right * 100.0f, 200, Color.White * 15.0f );
			new SceneLight( world, Vector3.Up * 100.0f + Vector3.Up, 200, Color.White * 35.0f );

			RenderScene = Add.ScenePanel( world, RenderScenePos, Rotation.From( RenderSceneAngles ), 75 );
